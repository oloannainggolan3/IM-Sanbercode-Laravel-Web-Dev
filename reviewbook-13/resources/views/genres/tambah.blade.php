...
@section('section-title')
    <span class="fw-bold text-dark display-6">HALAMAN TAMBAH GENRE</span>
@endsection
    ...
    <div class="container mt-5">
        <div class="card border-0 shadow-lg rounded-4">
            <div class="card-header text-white text-center py-4"
                ...
                <h3 class="mb-0">Form Tambah Genre</h3>
            </div>
                ...
                <form action="/genres/store" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="4"
                                  class="form-control form-control-lg border border-success rounded-3 shadow-sm"
                                  placeholder="Masukkan deskripsi genre">{{ old('description') }}</textarea>
                    </div>
