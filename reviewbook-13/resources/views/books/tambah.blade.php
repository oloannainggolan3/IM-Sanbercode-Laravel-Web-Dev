                ...
                <form action="/books/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-lg border border-success rounded-3"
                            id="title" name="title" value="{{ old('title') }}" placeholder="Masukkan judul buku">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control form-control-lg border border-success rounded-3" id="summary"
                            name="summary" rows="5" placeholder="Masukkan deskripsi buku">{{ old('summary') }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control form-control-lg border border-success rounded-3"
                            id="stok" name="stok" value="{{ old('stok') }}" placeholder="Masukkan jumlah stok">
                    </div>
